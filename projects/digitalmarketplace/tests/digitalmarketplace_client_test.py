...
from smart_contracts.artifacts.digitalmarketplace.digitalmarketplace_client import (
...
def test_delete_application(
    ...
    sc_amount = algorand.account.get_information(
    ...
    assert after_call_amount == before_call_amount + 3 * 300_000 + 200_000 - 3_000
